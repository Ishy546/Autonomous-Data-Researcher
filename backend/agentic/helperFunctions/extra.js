...
const availableFunctions = {
    getCurrentWeather,
    getLocation // same as writing getLocation: getLocation
}


// this is the og way to build ai agents, too much work and algorithmic planning so we are scrapping it!
// ReAct prompting
...
// console.log(await agent("What is the current weather in New York City?"))
*/
 ...
 * User Query
     ↓
SubQuestions Node (GPT-5-nano)
     ↓
Searcher Node (Tavily API)
     ↓
Fetcher Node (Firecrawl)
     ↓
Ranker Node (GPT-5-nano) / or maybe embeddings?
     ↓
Writer Node (GPT-5-nano)
     ↓
Final Report
 */